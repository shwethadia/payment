...
//uthController interface is a contract what this controler can do
...
func (c *authController) Login(ctx *gin.Context) {
	...
	response := helper.BuildErrorResponse("Please check your credetials", "Invalid Credential", helper.EmptyObj{})
